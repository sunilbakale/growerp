...
class RegisterForm extends StatelessWidget {
  ...
  const RegisterForm({Key key, this.newCompany}) : super(key: key);
    ...
    return BlocBuilder<AuthBloc, AuthState>(builder: (context, state) {
      ...
      return Scaffold(
        ...
        body: BlocProvider(
          ...
          child: RegisterHeader(authenticate),
        ),
      );
    });
  }
...
class RegisterHeader extends StatefulWidget {
  ...
  const RegisterHeader(this.authenticate);
  @override
  State<RegisterHeader> createState() => _RegisterHeaderState(authenticate);
}
...
class _RegisterHeaderState extends State<RegisterHeader> {
  ...
  _RegisterHeaderState(this.authenticate);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<RegisterBloc, RegisterState>(
      ...
      child:
        ...
        //       print(
        //           "====register form: current register state: ${state.runtimeType} " +
        //               "companyPartyId: ${authenticate?.company?.partyId}");

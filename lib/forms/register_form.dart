        ...
        listeners: [
          BlocListener<RegisterBloc, RegisterState>(listener: (context, state) {
            ...
            if (state is RegisterLoading) {
              HelperFunctions.showMessage(
                  context, 'Loading currencies ...', Colors.green);
            }
          ...
          child:
            ...
            return BlocBuilder<RegisterBloc, RegisterState>(
              ...
              String _currencySelected =
                  kReleaseMode ? '' : 'Thailand Baht [THB]';
              ...
              if (state is RegisterLoaded) currencies = state.currencies;
              return SizedBox(
                  width: 400,
                  child: Form(
                    key: _formKey,
                    child: ListView(
                      children: <Widget>[
                        ...
                        RaisedButton(
                            child:
                                Text('Register AND create new Ecommerce shop'),
                            onPressed: () {
                              String _currencyAbr = _currencySelected.substring(
                                  _currencySelected.indexOf('[') + 1);
                              _currencyAbr = _currencyAbr.substring(
                                  0, _currencyAbr.indexOf(']'));
                              if (_formKey.currentState.validate() &&

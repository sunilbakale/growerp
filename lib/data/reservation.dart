...
List <Reservation> reservations = [
  Reservation( id: 100, fromDate: DateTime(2018, 1, 29),
    thruDate: DateTime(2018 , 2, 1), roomId: 1, customerId: 3,
    customerName: "jan Jansen"),
  Reservation( id: 101, fromDate: DateTime(2018, 2, 1),
    thruDate: DateTime(2018 , 2, 17), roomId: 1, customerId: 3,
    customerName: "Piet lemmon"),
  Reservation( id: 102, fromDate: DateTime(2018, 3, 20),
    thruDate: DateTime(2018 , 4, 1), roomId: 2, customerId: 1,
    customerName: "Jan de boer"),
  Reservation( id: 102, fromDate: DateTime(2018, 1, 5),
    thruDate: DateTime(2018 , 1, 7), roomId: 2, customerId: 1,
    customerName: "Jan de boer"),
  Reservation( id: 102, fromDate: DateTime(2018, 1, 7),
    thruDate: DateTime(2018 , 1, 9), roomId: 2, customerId: 1,
    customerName: "Jan de boer"),
  Reservation( id: 103, fromDate: DateTime(2018, 1, 29),
    thruDate: DateTime(2018 , 1, 31), roomId: 3, customerId: 2,
    customerName: "Cees Jansma"),
  Reservation( id: 104, fromDate: DateTime(2018, 3, 10),
    thruDate: DateTime(2018 , 3, 20), roomId: 4, customerId: 2,
    customerName: "1Hans de Groot"),
  Reservation( id: 105, fromDate: DateTime(2018, 3, 20),
